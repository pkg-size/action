...
(async () => {
  ...
  assert_1__default.default(e, 'Environment variable "GITHUB_TOKEN" not set. Required for accessing and reporting on the PR.'), console.log("eventName", github.context.eventName);
