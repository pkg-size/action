...
const el = Qr("🤖 This report was automatically generated by [pkg-size-action](https://github.com/privatenumber/pkg-size-action/)");
...
(async () => {
    ...
    console.log("ref", Kr.context.ref);
    console.log("sha", Kr.context.sha);
    const r = await Xc({
        pr: t,
