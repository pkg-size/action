...
const COMMENT_SIGNATURE = sub(
	'🤖 This report was automatically generated by [pkg-size-action](https://github.com/pkg-size/action/)',
);
...
(async () => {
	...
	assert(
		GITHUB_TOKEN,
		"Environment variable 'GITHUB_TOKEN' not set. Required for accessing and reporting on the PR.",
	);
	...
	const sizeReport = await generateSizeReport({
		...
		installCommand: getInput('install-command'),
	});
